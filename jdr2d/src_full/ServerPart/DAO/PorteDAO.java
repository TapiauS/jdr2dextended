...
public abstract class PorteDAO extends DAOObject{
    public static ArrayList<Porte> getPorte(Map m) throws DAOException {
        try {
    ...
    public static void addPorte(Porte entre) throws  DAOException {
        try {
    ...
    public static void updatedtabase(Personnage player,Porte p) throws DAOException {
        try {
