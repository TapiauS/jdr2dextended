...
public abstract class QueteDAO extends DAOObject {
    ...
    public static ArrayList<Quete> getqueteSuivie(int id) throws  DAOException {
        try {
    ...
    public static Quete getQuete(int id) throws SQLException, DAOException {
        try {
    ...
    public static void update(Quete q, Personnage player) throws SQLException, DAOException {
        try {
            ...
            LOGGER.severe(e.getMessage());
            throw new DAOException(e.getMessage(),ErrorType.GENERALSEVERE);
        }
    }
