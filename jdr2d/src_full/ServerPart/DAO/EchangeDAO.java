...
public abstract class EchangeDAO extends DAOObject{
    ...
    public static PNJ getparleur(int id) throws SQLException, DAOException {
        try {
    ...
    public static Echange getEchangetree(PNJ perso) throws DAOException {
        try {
    ...
    private static Echange getechangesuivant(PNJ perso,int id) throws DAOException {
        try {
